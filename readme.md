...
- Since the data is relatively small, I decusernamee not to use any database system so we don't have to learn anything new 

| Section    |  Functional Duty                                |
| ---------- | ----------------------------------------------- |
| model      | handling the business logic and modify the data |
| view       | handling the end user I/O and interface         |
| controller | acting as the brusernamege between the other two      |
